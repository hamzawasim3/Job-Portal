    ...
    <div class="collapse navbar-collapse" id="navigation">
      <ul class="navbar-nav navbar-nav-hover mx-2">
        ...
        <div class="dropdown mx-auto" id="ddmenu">
          <button class="btn bg-gradient-warning mb-0 dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false" style="margin-left:10px;">Login/Register</button>
