      ...
      <div class="row" style="margin-top:40px;">
        <div>
          <div class="card z-index-0 fadeIn3 fadeInBottom">
            ...
            <?php echo form_open('Candidate/update_profile', 'class="text-start" id="update-candidate-form" name="update-candidate-form" onsubmit="return validemp()"'); ?>
            <div class="container">
            <div class="row">
              <div class="col-sm-5 col-md-6">
                ...
                <div class="dropify-wrapper"><div class="dropify-message">
                    ...
                    <p id="resume_msg">Resume Uploaded! Drag & drop or click to upload resume</p>
                    ...
                    </p><p class="dropify-infos-message">Resume Uploaded! Drag and drop or click to replace</p>
                  </div></div></div></div>
                  </form><br/>
                  <div id="elename" class="input-group input-group-outline my-3 is-filled">
                    <label class="form-label">Name</label>
                    <input type="text" name="name" id="name" class="form-control" value="<?php echo $name; ?>" required>
                  </div>
                  <div id="elerole" class="input-group input-group-outline my-3 is-filled">
                  ...
                  <option value="1" <?php if($company!=null) echo "selected"; ?>>&nbsp;&nbsp;Yes, I'm Employed.</option>
                  <option value="2" <?php if($company==null) echo "selected"; ?>>&nbsp;&nbsp;No, I'm not Employed.</option>
                  </select>
                  </div>
                  ...
                  <div id="elecompany" class="input-group input-group-outline my-3">
                    ...
                    <div class="col-sm-5 col-md-6">
                      <div class="input-group input-group-outline my-0">
                        ...
                        <option value="" disabled="" selected>&nbsp;&nbsp;Current Company Type*</option>
            ...
            <div class="col-sm-5 offset-sm-2 col-md-6 offset-md-0">
              ...
              <div class="image-upload" style="display: flex;justify-content: center;margin-top:67px;margin-bottom:67px">
                <label for="file-input2">
                  <img id="image_file2" src="<?php echo $image_url; ?>" style="max-height: 100px;">
                </label>
                <input id="file-input2" type="file" accept="image/jpeg, image/png"/>
              </div>       
              <div id="elephone" class="input-group input-group-outline my-3 is-filled">
                  <label class="form-label">Phone Number</label>
                  <input type="number" min="0" name="phone" id="phone" class="form-control" value="<?php echo $phone; ?>" required>
                </div>
                <div id="elelocation">
                ...
                <div id="eleexperience" class="input-group input-group-outline my-3 is-filled">
                  <label class="form-label">Experience</label>
                  <input type="number" min="0" max="50" name="experience"  id="experience" class="form-control" value="<?php echo $experience; ?>" required>
                </div>
                <div id="elelinkedin" class="input-group input-group-outline my-3 is-filled">
                ...
                <input type="hidden" id="resume_url" name="resume_url" value="<?php echo $resume_url; ?>"> 
            </div>
                <div class="text-center">
                  <button type="submit" form="update-candidate-form" class="btn w-auto my-4 mb-2 text-white" style="background-color: rgb(109, 3, 109);">Update</button>
                </div>
                </form>
            </div>
          </div>
...
function button_close(){
  ...
  function validemp(){
    let flag = 0;
  if(!(input_fields.plaintext.test(document.forms["update-candidate-form"]["name"].value))){
    flag = 1;
  }
  if(!(input_fields.phone.test(document.forms["update-candidate-form"]["phone"].value))||((document.forms["update-candidate-form"]["phone"].value.length<10)||(document.forms["update-candidate-form"]["phone"].value.length>13))){
    flag = 1;
  }
  if(!(input_fields.plaintext.test(document.forms["update-candidate-form"]["role"].value))){
    flag = 1;
  }
if(document.forms["update-candidate-form"]["employee_status"].value == 1){
  if(!(input_fields.plaintext.test(document.forms["update-candidate-form"]["currentrole"].value))){
    flag = 1;
  }
  if(!(input_fields.plaintext.test(document.forms["update-candidate-form"]["company"].value))){
    flag = 1;
  }
}
  if(!(input_fields.location.test(document.forms["update-candidate-form"]["location"].value))){
    flag = 1;
  }
  if(!(input_fields.phone.test(document.forms["update-candidate-form"]["experience"].value))){
    flag = 1;
  }
  if(document.forms["update-candidate-form"]["linkedin"].value != ""){
  if(!(input_fields.url.test(document.forms["update-candidate-form"]["linkedin"].value))){
    console.log("11");
    flag = 1;
  }
}
  if(document.forms["update-candidate-form"]["image_url"].value == ""){
    flag = 1;
  }
  if(document.forms["update-candidate-form"]["resume_url"].value == ""){
    flag = 1;
  }
  if(flag == 1){
