...
?>
    <div class="row" style="margin-top:40px;">
      <div class="row justify-content-center text-center my-sm-5">
        <div class="col-lg-6">
          <h2 class="text-dark mb-0">Applied Jobs</h2>
        </div>
      </div>
    </div>
  </div>
<div style="display: flex;justify-content: center;">
  <div class="card" style="width: 80%;">
    <div class="table-responsive">
      <table class="table align-items-center mb-0" id="applied_jobs" style="border-color:transparent">
        <thead>
        ...
        for($i=0;$i<count($jobs);$i++) { ?>
          <tr style="border-color:#f0f2f5">
            <td class="text-center text-sm">
              <p class="text-xs font-weight-bold mb-0"><?php echo $jobs[$i][0]->job_title; ?></p>
            </td>
            <td class="text-center text-sm">
              <p class="text-xs font-weight-bold mb-0"><?php echo $jobs[$i][0]->location; ?></p>
            </td>
            <td class="text-center text-sm">
              <p class="text-xs font-weight-bold mb-0"><?php echo $jobs[$i][0]->experience; ?></p>
            </td>
            <td class="text-center text-sm">
              <p class="text-xs font-weight-bold mb-0"><?php echo $jobs[$i][0]->job_type; ?></p>
            </td>
            <td class="text-center align-middle">
            <a href="<?php echo base_url('candidate/view_job/'.$jobs[$i][0]->job_id.''); ?>">
                <button class="btn bg-gradient-warning mb-0" type="button">View Job</button> 
              </a>
              <a href="<?php echo base_url('candidate/disapply/'.$jobs[$i][0]->job_id.''); ?>">
...
<script>
  $(document).ready( function () {
    $('#applied_jobs').DataTable({paging: false,searching:false,info: false,"order": [],
