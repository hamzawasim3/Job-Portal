...
?>
      <div class="row" style="margin-top:40px;">
          ...
          <div class="card z-index-0 fadeIn3 fadeInBottom">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="col-lg-4 col-md-8 col-12 mx-auto shadow-primary border-radius-lg py-3 pe-1" style="background-color: rgb(109, 3, 109);">
                <h4 class="text-white font-weight-bolder text-center mt-2 mb-2">Add Job</h4>
              </div>
            </div>
            <div class="card-body">
              <style>
              ...
              <?php echo form_open('Recruiter/submit_job', 'class="text-start" id="add-job-form" name="add-job-form" onsubmit="return validadd()"'); ?>
                <div class="input-group input-group-outline my-3">
                  <label class="form-label">Job Title*</label>
                  <input type="text" name="jobtitle" id="job_title" class="form-control" value="" required>
                </div>
                <div class="input-group input-group-outline my-3">
                  <label class="form-label">Experience*</label>
                  <input type="number" min="0" name="experience" id="experience" class="form-control" value="" required>
                </div>
                <div id="elelocation">
                  ...
                  <input type="text" class="form-control" name="app_deadline" required>
                ...
                <input type="tags" name="skills" id="skills" value="" autofocus><br>
        ...
        if(!empty(set_value('jobdescription'))) {
          echo set_value('jobdescription');
        }
        else{ 
          echo $jobdescription; 
        }
        ?></textarea>
                <div class="text-center">
                  <button type="submit" class="btn w-auto my-4 mb-2 text-white" style="background-color: rgb(109, 3, 109);" form="add-job-form">Add</button>
                </div>
            </form>
        </div>
      </div>
